...
import { ICommonCodeEditor, IEditorContribution, IModel, IHistoryElement } from 'vs/editor/common/editorCommon';
import { HistoryEvent } from 'vs/editor/common/model/textModelEvents';
import { EditorContextKeys } from 'vs/editor/common/editorContextKeys';
import { editorAction, ServicesAccessor, EditorAction, CommonEditorRegistry, EditorCommand } from 'vs/editor/common/editorCommonExtensions';
...
@editorAction
export class HistoryTreeAction extends EditorAction {
	constructor() {
		super({
...
export class HistoryTreeController extends Disposable implements IEditorContribution {
	...
	public static get(editor: ICommonCodeEditor): HistoryTreeController {
...
class HistoryTreeWidget extends Widget implements IOverlayWidget {
	...
	constructor(editor: ICodeEditor, contextKeyService: IContextKeyService, private _keybindingService: IKeybindingService, private _themeService: IThemeService) {
		super();
	...
	*/
	...
	public show(): void {
		...
		this._showDisposables.push(this._model.onHistoryChanged((e) => {
...
CommonEditorRegistry.registerEditorCommand(new HistoryTreeCommand({
	id: 'closeHistoryTree',
